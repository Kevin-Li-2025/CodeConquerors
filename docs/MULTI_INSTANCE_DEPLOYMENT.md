...
The production route graph cache stores packed binary versioned artifacts instead of nested
...
landmark count; it reports full extract graph size, shard reuse, artifact size, binary Redis
